...
class H3DynamicCFGScheduler:
    ...
    RETURN_NAMES = ("model",)
    FUNCTION = "patch"
    CATEGORY = "gosick_233/MiniMax H3/scheduler"
...
NODE_CLASS_MAPPINGS = {
    "gosick_233_H3DynamicCFGScheduler": H3DynamicCFGScheduler,
}

NODE_DISPLAY_NAME_MAPPINGS = {
    "gosick_233_H3DynamicCFGScheduler": "gosick_233 · H3 Dynamic CFG Scheduler",
}
