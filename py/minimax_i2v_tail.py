...
class MiniMaxH3ImageToVideoTail(io.ComfyNode):
    ...
    def define_schema(cls):
        return io.Schema(
            node_id="gosick_233_MiniMaxH3ImageToVideoTail",
            display_name="MiniMax H3 Image to Video (Tail)",
            category="gosick_233/MiniMax H3/conditioning",
            description=(
...
NODE_CLASS_MAPPINGS = {
    "gosick_233_MiniMaxH3ImageToVideoTail": MiniMaxH3ImageToVideoTail,
}

NODE_DISPLAY_NAME_MAPPINGS = {
    "gosick_233_MiniMaxH3ImageToVideoTail": "gosick_233 · MiniMax H3 Image to Video (Tail)",
}
